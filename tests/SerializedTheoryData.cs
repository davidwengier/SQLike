...
namespace StarNet.StarQL.Tests
{
	...
	public class SerializedTheoryData : IEnumerable<object[]>
	{
		...
		private bool IsSerializable(object arg)
		{
			...
			Type t = typeof(Xunit.Sdk.XunitTest).Assembly.GetType("Xunit.Serialization.XunitSerializationInfo", true, true);
			MethodInfo method = t.GetMethod("CanSerializeObject", BindingFlags.Static | BindingFlags.NonPublic);
